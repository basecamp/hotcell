...
class VersionTest < ActiveStorageHotCellClientTest
  ...
  def test_this_gem_reports_the_version_its_gemspec_builds
    ...
    assert_equal version, ActiveStorage::HotCell::Client::VERSION, "run `rake version:bump` from the repository root"
  end
end

...
module ActiveStorage
  module HotCell
    ...
    #
    #   config.active_storage.previewers = [ ActiveStorage::HotCell::PdfPreviewer,
    #                                        ActiveStorage::HotCell::VideoPreviewer ]
    #
    ...
    class PdfPreviewer < ActiveStorage::Previewer::MuPDFPreviewer
      ...
      def preview(**options)
        download_blob_to_tempfile do |input|
          render_through(Clients::PreviewPdf, input, ".png", "image/png") do |attachable|
    ...
    class VideoPreviewer < ActiveStorage::Previewer::VideoPreviewer
      ...
      def preview(**options)
        download_blob_to_tempfile do |input|
          render_through(Clients::PreviewVideo, input, ".jpg", "image/jpeg") do |attachable|
            yield(**attachable, **options)
          end
        end
      end
